class Sympow < Formula
  desc "Compute special values of symmetric power elliptic curve L-functions"
  homepage "https://gitlab.com/rezozer/forks/sympow/"
  url "https://gitlab.com/rezozer/forks/sympow/-/archive/v2.023.7/sympow-v2.023.7.tar.bz2"
  ...
  def install
    ...
    ENV["VARPREFIX"] = var.to_s
    system "./Configure"
    system "make", "install"
  end

  test do
    assert_match "Modular Degree is 464",
      shell_output("#{bin}/sympow  -curve '[1,2,3,4,5]' -moddeg | grep Modular")
  end
end
